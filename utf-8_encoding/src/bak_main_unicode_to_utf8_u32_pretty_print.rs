...
fn pretty_print_1byte(point_u32: u32) {
    println!(
        "{BRNB}U+{:04x} ({}) ↔ {BLU}{:08b}{NC}",
        point_u32,
        char::from_u32(point_u32).unwrap_or('�'),
        point_u32
    );
    println!("{} {BRNB}{:#04x}{NC}", " ".repeat(12), point_u32);
}
...
fn pretty_print_4bytes(point_u32: u32, byte1: u8, byte2: u8, byte3: u8, byte4: u8) {
    println!(
        "{BRNB}U+{:06x} ({}) ↔ {BLU}{:08b} {:08b} {:08b} {:08b}{NC}",
        point_u32,
        char::from_u32(point_u32).unwrap_or('�'),
        byte1,
        byte2,
